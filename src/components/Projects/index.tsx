...
const Projects = () => {
  return (
    <>
      <section className="mt-16  text-center pb-32 text-sm max-sm:text-xs">
              ...
              <section className="px-3 py-2">
                ...
                <section className="flex flex-wrap mt-2">
                  {list.techStack.map(tech => (
                    <span
                      key={tech}
                      className="bg-[#f7f7f7]  font-medium px-2 py-1 text-xs rounded-md mr-2"
                    >
                      {tech}
                    </span>
                  ))}
                ...
                <section className="flex gap-3 mt-3">
                  <a
                    href={list.liveLink}
                    target="_blank"
                    className="px-2 py-1 text-xs flex gap-1 items-center rounded-md bg-black text-white "
                  >
